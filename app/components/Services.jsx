...
const Services = () => {
    return (
        <motion.div
            ...
            className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo ">I am a web developer from Casablanca, Morocco, and the creator of the
            Spouuu e-commerce website.</motion.p>
                <motion.div 
                initial={{ opacity:0}}
                whileInView={{opacity:1}}
